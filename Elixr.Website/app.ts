...
import CreatureDescriptionController from "./creature-editor/creature-description/creature-description";
import CreatureAbilitiesController from "./creature-editor/creature-abilities/creature-abilities";
import CreatureEnergyController from "./creature-editor/creature-energy/creature-energy";
import CreatureDefenseController from "./creature-editor/creature-defense/creature-defense";
import CreatureWeaponsController from "./creature-editor/creature-weapons/creature-weapons";
import CreatureWealthController from "./creature-editor/creature-wealth/creature-wealth";
import CreatureItemsController from "./creature-editor/creature-items/creature-items";
import CreatureFeaturesController from "./creature-editor/creature-features/creature-features";
...
import RPGSpellsController from "./magic/directives/rpg-spells";
...
rpgModule.directive(CreatureDescriptionController.directive.name, () => CreatureDescriptionController.directive);
rpgModule.directive(CreatureAbilitiesController.directive.name, () => CreatureAbilitiesController.directive);
rpgModule.directive(CreatureEnergyController.directive.name, () => CreatureEnergyController.directive);
rpgModule.directive(CreatureDefenseController.directive.name, () => CreatureDefenseController.directive);
rpgModule.directive(CreatureWeaponsController.directive.name, () => CreatureWeaponsController.directive);
rpgModule.directive(CreatureWealthController.directive.name, () => CreatureWealthController.directive);
rpgModule.directive(CreatureItemsController.directive.name, () => CreatureItemsController.directive);
rpgModule.directive(CreatureFeaturesController.directive.name, () => CreatureFeaturesController.directive);
...
rpgModule.directive(RPGSpellsController.directive.name, () => RPGSpellsController.directive);
